                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php $i=1; foreach($all_courses as $cdata) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="tel:<?php echo $cdata['mobile']; ?>"><?php echo $cdata['mobile'];?></a></td>
                                        
                                        <td class="center"><?php echo date('d-M-Y', strtotime($cdata['create_date']));?></td>
                                        <td class="center">
														<a href="<?php echo base_url();?>enquiry/call/<?php echo $cdata['id'];?>" class="label label-primary label-sm">Call</a> &nbsp;
