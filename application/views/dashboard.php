...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Welcome ISKCON Palwal, Hare Krishna</h1>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
									<?php if($noRe[0]['r'] != '') { echo $noRe[0]['r']; }else { echo '0'; } ?>
									</div>
                                    <div>Total Devotees</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
