           ...
           <?php if($this->session->flashdata('success_msg')) { ?>
				...
				<?php }  ?>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php $i = 0; foreach($all_courses as $cdata) { ?>
                                    <tr class="odd gradeX">
									<td><?php $i++; echo $i.".";?></td>
                                        <td><?php echo $cdata['particular'];?></td>
                                        <td><?php echo $cdata['amount']; ?></td>
                                        <td><?php echo $cdata['quantity'];?></td>
                                        <td><?php echo $cdata['total_amount'];?></td>
                                        <td><?php echo date('d-M-Y', strtotime($cdata['particular_date']));?></td>
                                        <td class="center"><?php echo $cdata['remark'];?></td>
                                        <td class="center">
														<a href="<?php echo base_url();?>expense/edit/<?php echo $cdata['id'];?>" class="label label-success label-sm">Edit</a> &nbsp;
