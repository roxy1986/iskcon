<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>user/dashboard">ISKCON PALWAL</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Devotee<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>student/new_student">New</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>student">All Devotees</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Income<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>income/new_income">New </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>income">All Income</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>expense	">All Expenses</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						                        ...
						                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Attendance<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                 
                                <li>
                                    <a href="<?php echo base_url();?>attendance">All Devotees</a>
									
                                </li>
								<li>
								 <a href="<?php echo base_url();?>attendance/report">Report</a>
								</li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
