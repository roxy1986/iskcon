            ...
            <div class="row">
             ...
             <div class="col-md-8"> <br>          
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                      <form action="<?php echo base_url(); ?>SetUp/add" onSubmit="return validate();"  method="post" accept-charset="utf-8">
										<div class="col-md-4">
											<div class="form-group">
												<label>Paper Code</label>
												<input class="form-control" name="paper_code" value="">
											</div>
											<div class="form-group">
												<label>Min Marks</label>
												<input class="form-control" name="min_marks" value="">
											</div>
										</div>
										<div class="col-md-4">
										<div class="form-group">
											...
											<div class="form-group">
												...
												<input class="form-control" type="text" name="max_marks" value="">
											</div>
										</div>
