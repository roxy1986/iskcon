                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" readonly="" name="bname" value="<?php  if(set_value('sname')) { echo set_value('bname'); } else { echo $book_data['book_name'];} ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" readonly="" name="bcode" value="<?php  if(set_value('bocde')) { echo set_value('bcode'); } else { echo $book_data['book_code'];} ?>">
                                         ...
                                         <div class="col-md-6">
                                          <div class="form-group">
                                             <label>No. Of Sale Books( <span style="color:red;">in stock <?php echo $book_data['book_quantity'];?> books </span>)</label>
