                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php $ii=1; foreach($all_students as $cdata) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="tel:<?php echo $cdata['phone']; ?>">
											<?php echo $cdata['phone'];?></a></td>
                                        <td class="center"><?php echo $cdata['address'];?></td>
                                        </td>
                                        ...
                                        <td class="center" style="width:20%;">
												...
												<a href="<?php echo base_url();?>student/fee/<?php echo $cdata['enrollment'];?>" class="label label-primary label-sm">Call</a> 
