                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="aadhar" value="<?php  if(set_value('aadhar')) { echo set_value('aadhar'); } else { echo $student_data['aadhar_no'];} ?>">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="mname" value="<?php  if(set_value('mname')) { echo set_value('mname'); } else { echo $student_data['mname'];} ?>">
                                        ...
                                        <div style="clear:both;"></div>
                                         <div class="col-md-4">
                                           <div class="form-group">
                                             <label>Course</label>
                                            <select name="course_name" class="form-control" onchange="load_more(this.value);" readonly onclick="this.readonly = false" onblur="this.readonly = true">
                                        ...
                                        <div class="form-group">
                                           <label>Discount</label>
                                            <input class="form-control" name="discount" value="<?php  if(set_value('discount')) { echo set_value('discount'); } else { echo $student_data['course_discount'];} ?>">
