...
<div class="col-xs-12" id="record">
	...
	<div class="col-xs-6">Rs <?php echo $student_data['amount_to_paid'];?></div>
</div>
<div class="col-xs-12" id="record">
	<div class="col-xs-6">Amount</div>
	<div class="col-xs-6">Rs <?php echo $receipt_data['amount'];?></div>
</div>
<div class="col-xs-12" id="record">
	<div class="col-xs-6">Balance</div>
	<div class="col-xs-6">Rs <?php echo $student_data['amount_to_paid'] - $amount_deposited; ?></div>
</div>
<div class="col-xs-12" id="record">
