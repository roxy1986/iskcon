   ...
   public function new_student() 
     {
			...
			$chanting = $this->input->post('chanting');
			$hearing = $this->input->post('hearing');
			$reading_books = $this->input->post('reading_books');
			$ashray_member = $this->input->post('ashray_member');
			$seva = $this->input->post('seva');
