           ...
           <?php if($this->session->flashdata('success_msg')) { ?>
				...
				<?php }  ?>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                      <?php echo form_open('expense/edit/'.$exp_data['id']);?>
                                      <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="qnty" onkeyup="all_expense();"  name="quantity" value="<?php  if(set_value('quantity')) { echo set_value('quantity'); } else { echo $exp_data['quantity'];} ?>" >
                                        ...
                                        <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" id="total_expense" name="total" value="<?php  if(set_value('total')) { echo set_value('total'); } else { echo $exp_data['total_amount'];} ?>">
